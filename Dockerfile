...
# Create /dev/disk/by-id directory to fix macOS Sequoia compatibility (issues #100, #91)
# AceStream expects this directory to exist but Docker Desktop on macOS doesn't mount it
